namespace examEvaluation
{
    ...
    class ScoreCard
    {
        ...
        public void ShowDetails()
        {
            ...
            foreach (Student student in students)
            {
                englishAVG += student.English;
                mathsAVG += student.Math;
                sstAVG += student.SST;
                scienceAVG += student.Science;
                langavg += student.Language;
            }
            Console.WriteLine("Average Subject Marks of all the students");
            Console.WriteLine($"The Average marks in English is {englishAVG / n}");
            Console.WriteLine($"The Average marks in Maths is {mathsAVG / n}");
            Console.WriteLine($"The Average marks in Social Studies is {sstAVG / n}");
            Console.WriteLine($"The Average marks in Science is {scienceAVG / n}");
            Console.WriteLine($"The Average marks in Language is {langavg / n}");
        }
